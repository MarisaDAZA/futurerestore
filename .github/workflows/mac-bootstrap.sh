...
cd ${WORKFLOW_ROOT}
curl -sLO https://github.com/MarisaDAZA/futurerestore/releases/download/bootstrap/bootstrap_x86_64.tar.zst &
curl -sLO https://github.com/MarisaDAZA/futurerestore/releases/download/bootstrap/macOS_x86_64_Release_Latest.tar.zst &
curl -sLO https://github.com/MarisaDAZA/futurerestore/releases/download/bootstrap/macOS_arm64_Release_Latest.tar.zst &
curl -sLO https://github.com/MarisaDAZA/futurerestore/releases/download/bootstrap/macOS_x86_64_Debug_Latest.tar.zst &
curl -sLO https://github.com/MarisaDAZA/futurerestore/releases/download/bootstrap/macOS_arm64_Debug_Latest.tar.zst &
wait
